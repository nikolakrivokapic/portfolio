export default {
  text1: `I am software developer, mainly focused on full stack web development,
     with around 8 years of professional experience, working mostly remotely as part of the agile teams. 
